...
function update() {
	...
	if (dis){
		...
		document.gen.def.value = "# Definition for " + document.bld.so.value + " created by Defgen 1.3 on <?=$now?>\n" +
		"\n# General\n" +
...
<th width=80 rowspan=3><a href=<?=$_SERVER['PHP_SELF'] ?>>
<img src="img/32/tab.png" title="Assists in generating device definitions.">
</a></th><td>
...
<tr class="<?=$modgroup[$self]?>2"><th colspan=4>
...
<img src="img/16/dev.png"" align=right>
General</th></tr>
<tr><th align=right>
SysObjId</th><td>
...
<input type="text" name="ico" value="<?=$ico?>" size="24" onfocus=select(); onchange="update();">
 <img src="img/16/tabi.png" onClick="window.open('inc/browsedev.php','Icons','scrollbars=1,menubar=0,resizable=1,width=400,height=600');" title="Browse available icons">
</td><th align=right>
Bridge</th><td>
...
<img src="img/16/dumy.png"" align=right>
Interfaces</th></tr>
<tr><th align=right>
IF Alias</th><td>
...
<img src="img/16/dmsc.png"" align=right>
Modules</th></tr>
<tr><th align=right>
Slot</th><td>
...
<img src="img/16/dlog.png"" align=right>
RRD Graphing</th></tr>
<tr><th align=right>
CPU Util</th><td>
